#!/usr/bin/env node
// Converte ROTEIROS_72_ANJOS.md → ROTEIROS_72_ANJOS.pdf usando Chrome headless.
...
const MD = path.join(ROOT, 'ROTEIROS_72_ANJOS.md');
const HTML_TMP = path.join(ROOT, '.tmp-roteiros.html');
const PDF = path.join(ROOT, 'ROTEIROS_72_ANJOS.pdf');
